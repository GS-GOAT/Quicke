import errorService, { ERROR_TYPES, TIMEOUT_SETTINGS, streamUtils } from './errorService';
 ...
 */
export async function handleUnifiedModelStream(options) {
  const {
    modelId,
    prompt,
    sendEvent,
  ...
  try {
    ...
    try {
      // Add a safety check to ensure the stream is iterable
